...
QUOTES = [
    ...
    {
        "id": 5,
        "text": "Programs must be written for people to read, and only secondarily for machines to execute.",
...
def home():
    return {
        ...
        "endpoints": {"get_random_quote": "GET /quote", "submit_typing_test": "POST /submit"},
    }
